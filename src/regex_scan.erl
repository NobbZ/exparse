...
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 35 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 37, C =< 39 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 47, C =< 62 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 64, C =< 90 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [C|Ics], Line, Tlen, Action, Alen) when C >= 95, C =< 123 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/regex_scan.xrl", 3).
yyaction_0(TokenLine) ->
     { token, { '|', TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("src/regex_scan.xrl", 4).
yyaction_1(TokenLine) ->
     { token, { '*', TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("src/regex_scan.xrl", 5).
yyaction_2(TokenLine) ->
     { token, { '+', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("src/regex_scan.xrl", 6).
yyaction_3(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/regex_scan.xrl", 7).
yyaction_4(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("src/regex_scan.xrl", 8).
yyaction_5(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_6/1}).
-file("src/regex_scan.xrl", 9).
yyaction_6(TokenLine) ->
     { token, { '$', TokenLine } } .

-compile({inline,yyaction_7/1}).
-file("src/regex_scan.xrl", 10).
yyaction_7(TokenLine) ->
     { token, { '\\', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/regex_scan.xrl", 11).
yyaction_8(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/regex_scan.xrl", 12).
yyaction_9(TokenLine) ->
     { token, { '[^', TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/regex_scan.xrl", 13).
yyaction_10(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("src/regex_scan.xrl", 14).
yyaction_11(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("src/regex_scan.xrl", 15).
yyaction_12(TokenLine) ->
     { token, { '?', TokenLine } } .

-compile({inline,yyaction_13/1}).
-file("src/regex_scan.xrl", 16).
yyaction_13(TokenLine) ->
     { token, { '^', TokenLine } } .

-compile({inline,yyaction_14/2}).
-file("src/regex_scan.xrl", 17).
yyaction_14(TokenChars, TokenLine) ->
