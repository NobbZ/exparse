...
-module(ex_parse_scan_gen_scanner).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/ex_parse_scan_gen_scanner.xrl", 9).
...
-file("src/ex_parse_scan_gen_scanner.erl", 284).
yystate() -> 1.
...
yystate(1, [97|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [91|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(1, [C|Ics], Line, Tlen, Action, Alen) when C >= 108, C =< 110 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/ex_parse_scan_gen_scanner.xrl", 5).
yyaction_0(TokenChars, TokenLine) ->
